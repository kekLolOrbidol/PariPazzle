...
//            Log.d(TAG, "Bundle received: $puzzleData")
            ...
            puzle = convertDataToPuzzle(puzzleData)
        }
        if (bundle == null || puzle == null) {
//            Log.d(TAG, "No bundle received!")
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (solverDataReceived && puzle != null) {
            val puzzleSolver = PuzleSolver(puzle!!)
...
//            Log.d(TAG, "Puzzle solver solution: ${puzzleSolver.solution()}")
     ...
     */
    private fun convertDataToPuzzle(puzzleData: String?): Puzle? {
        if (puzzleData == null) {
            return null
        }
